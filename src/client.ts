import { g, H, hashOutputBytes, k, N } from "./lib/params";
...
export const generateSalt = () => randomBigInt(hashOutputBytes);
...
export function deriveVerifier(privateKey: bigint): bigint {
